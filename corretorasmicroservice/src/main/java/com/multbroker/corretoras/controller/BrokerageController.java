...
public class BrokerageController {
	...
	public BrokerageAccountDTO findAccountById(@PathVariable("id") String id){
		return brokerageAccountService.findAccountById(Long.parseLong(id));
	}
	
	@RequestMapping(value = "/findbyid/{id}", method = RequestMethod.GET)
	public Brokerage findById(@PathVariable("id") String id){
		return brokerageService.findById(Long.parseLong(id));
	}
	
	@RequestMapping(value = "/findaccountsbyuser/{id}", method = RequestMethod.GET)
	public List<BrokerageAccountDTO> findAccountByUser(@PathVariable("id") String id){
		return brokerageAccountService.findAllByUser(Long.parseLong(id));
	}
