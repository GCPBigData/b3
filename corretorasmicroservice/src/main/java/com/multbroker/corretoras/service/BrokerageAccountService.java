...
public class BrokerageAccountService {
	...
	public BrokerageAccountDTO findAccountById(Long idAccount) {
		...
		dto.setId(brokerAccount.getId().intValue());
		dto.setUserId(brokerAccount.getUser().getId().intValue());
		dto.setBrokerageId(brokerAccount.getBrokerage().getId().intValue());
	...
	public List<BrokerageAccountDTO> findAllByUser(Long idUsuario){
		...
		for(BrokerageAccount broker : lista) {
			...
			dto.setId(broker.getId().intValue());
			dto.setUserId(broker.getUser().getId().intValue());
			dto.setBrokerageId(broker.getBrokerage().getId().intValue());
